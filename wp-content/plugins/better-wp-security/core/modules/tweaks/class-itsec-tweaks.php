...
class ITSEC_Tweaks {
	...
	function get_jquery_version() {
		...
		if ( ( is_home() || is_front_page() ) && is_user_logged_in() ) {
			...
			// Notice: Trying to get property of non-object in /Applications/MAMP/htdocs/starter-kit/wp-content/plugins/better-wp-security/core/modules/tweaks/class-itsec-tweaks.php on line 210
