...
class ITSEC_Four_Oh_Four_Admin {
	...
	public function dashboard_status( $statuses ) {
		...
		if ( $this->settings['enabled'] === true ) {
			...
			$status       = array(
				'text' => __( 'Your site is protecting against bots looking for known vulnerabilities.', 'it-l10n-ithemes-security-pro' ),
			...
			$status       = array(
				'text' => __( 'Your website is not protected against bots looking for known vulnerabilities. Consider turning on 404 protection.',
				              'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_four_oh_four_enabled',
			);
