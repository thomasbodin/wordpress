...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/img/avatar.png" />

    <!-- Scripts -->
    <script src="//code.jquery.com/jquery-1.11.2.min.js"></script>
    <script type='text/javascript' src="<?php bloginfo( 'template_directory' ); ?>/library/js/bootstrap.min.js"></script>
    <link href="<?php bloginfo( 'template_directory' ); ?>/library/outdatedbrowser/outdatedbrowser.min.css" rel="stylesheet">
